...
class Station:
    ...
    def process_message(self, json_data):
        ...
        if "COUNT" in json_data:
        ...
        elif "station_id" in json_data:
            direction = json_data.get("direction")
            train_id = json_data.get("train_id")
            train_status = json_data.get("train_status")
            ...
            if direction == "a":
                ...
                self.dir_b = status_dict
            elif "arrival" in json_data.get("topic", "").lower():  # Check if "arrival" is in the topic
                self._handle_arrival(json_data)  # Call _handle_arrival for arrival messages
